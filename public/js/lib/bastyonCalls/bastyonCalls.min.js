        ...
        379: t => {
          ...
          function i(t, i) {
            for (var r = {}, a = [], c = 0; c < t.length; c++) {
              ...
              if (-1 !== f) e[f].references++, e[f].updater(v);
                ...
                var h = o(v, i);
                (i.byIndex = c),
                  e.splice(c, 0, { identifier: u, updater: h, references: 1 });
              }
              a.push(u);
            }
            return a;
          ...
          t.exports = function (t, o) {
            ...
            return function (t) {
              ...
              for (var l = i(t, o), s = 0; s < r.length; s++) {
                var d = n(r[s]);
    ...
    return (
      (() => {
        ...
        function x() {
          ...
          var b = (v.prototype = u.prototype = Object.create(h));
          function y(t) {
          ...
          function w(t, e) {
            function i(o, r, a, c) {
              ...
              if ("throw" !== l.type) {
                var d = l.arg,
                  u = d.value;
                return u && "object" == g(u) && n.call(u, "__await")
        ...
        var T = (function (t) {
            ...
            function a(t, e, n, i) {
              ...
              return (
                ...
                j(A((o = r.call(this))), "controls", {}),
                j(A(o), "isFrontalCamera", !1),
                j(A(o), "videoStreams", null),
                j(A(o), "isMuted", !1),
                j(A(o), "activeCall", null),
                j(A(o), "secondCall", null),
                j(A(o), "syncInterval", null),
                j(A(o), "isWaitingForConnect", !1),
                j(A(o), "signal", null),
                j(A(o), "timer", null),
                j(A(o), "timeInterval", null),
                j(A(o), "title", null),
                j(A(o), "blinkInterval", null),
                j(A(o), "destroyed", !1),
                j(A(o), "templates", {
                ...
                j(A(o), "renderTemplates", {
                  videoCall: function () {
                    var t;
                    o.root &&
                      ((o.root.innerHTML =
                        (null === (t = o.templates.videoCall) || void 0 === t
                          ? void 0
                          : t.call(A(o))) || ""),
                      o.initCallInterface("videoCall"));
                  },
                  incomingCall: function (t) {
                    var e, n, i, r, a;
                    o.notify &&
                      ...
                      void 0 === r
                        ...
                        : r.callId) === t.callId
                        ? ((o.notify.innerHTML =
                            (null === (a = o.templates.incomingCall) ||
                            void 0 === a
                              ? void 0
                              : a.call(A(o), t)) || ""),
                          o.initCallInterface("incomingCall", t))
                        : t.reject("busy"));
                  },
                  clearNotify: function () {
                    o.notify && (o.notify.innerHTML = "");
                  },
                  clearVideo: function () {
                    o.root && (o.root.innerHTML = "");
                  },
                  clearInterface: function () {
                    o.root &&
                      (o.root.classList.remove("active"),
                      o.cancelMini(),
                      o.root.classList.remove("middle"),
                      o.root.classList.remove("full"));
                  },
                  endedCall: function (t) {
                    var e;
                    o.root &&
                      (o.root.classList.contains("minified") && o.cancelMini(),
                      (o.root.innerHTML =
                        (null === (e = o.templates.endedCall) || void 0 === e
                          ? void 0
                          : e.call(A(o), t)) || ""));
                  }
                }),
              ...
              (n = [
                {
                  ...
                  value: function () {
                    ...
                    (this.destroyed = !0),
                      ...
                      this.secondCall && this.secondCall.hangup(),
                      this.clearTimer(),
                      this.clearBlinking(),
                      clearInterval(this.syncInterval),
                      null === (t = this.signal) || void 0 === t || t.pause(),
                      (this.signal = null),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    t.insertAdjacentHTML(
                      ...
                      (this.container =
                        document.getElementById("bc-container")),
                      window &&
                                  ...
                                  case 5:
                                    t.clearBlinking(),
                                      ...
                                      null != t &&
                                        ...
                                        void 0 !== i &&
                                        i.onIncomingCall &&
                                        t.options.onIncomingCall(n),
                                      (o =
                                        t.client.store.rooms[n.roomId]
                                          .currentState.members),
                                      (r = Object.keys(o).filter(function (e) {
                                        return (
                                          e !== t.client.credentials.userId
                                        );
                                      })),
                                      (a = o[r]),
                                      (c = o[t.client.credentials.userId]),
                                      (n.initiator = a),
                                      (n.user = c),
                                      t.options
                                            ...
                                            if (
                                              ...
                                              if (t.secondCall)
                                                ...
                                                return (
                                                  ...
                                                  (t.signal.src =
                                                    "sounds/incoming.mp3"),
                                                  void t.renderTemplates.incomingCall(
                                                    n
                                                  )
                                                );
                                              }
                                            } else t.activeCall = n;
                                            var o = new Audio("js/lib");
                                            (o.autoplay = !0),
                                              (o.loop = !0),
                                              (o.volume = 0.5),
                                              (t.signal = o),
                  ...
                  value: function () {
                    ...
                    null === (t = this.signal) || void 0 === t || t.pause(),
                      this.initCordovaPermisions()
                        .then(function () {
                          try {
                            "connected" !== e.activeCall.state &&
                            "ended" !== e.activeCall.state
                              ? (e.activeCall.answer(!0, !0),
                                e.renderTemplates.clearNotify(),
                                e.renderTemplates.videoCall())
                              : ((e.isWaitingForConnect = !0),
                                e.renderTemplates.clearNotify(),
                                e.activeCall.hangup(),
                                setTimeout(function () {
                                  if (!e.destroyed)
                ...
                },
                {
                  ...
                  value: function () {
                    var t = this,
                      e = document.querySelector(".bc-video-container");
                        ...
                        if (
                          ...
                          var i,
                            o = (
                              ...
                              void 0 === i
                                ? void 0
                                : i.remoteUsermediaStream.getVideoTracks()[0]
                            ).getSettings().aspectRatio;
                          o &&
                            ((e.style.aspectRatio = 1 / o),
                            o > 1
                        ...
                        return window.cordova &&
                          ...
                          ? cordova.plugins.EnumerateDevicesPlugin.getEnumerateDevices().then(
                              function () {
                                ...
                                return (
                                  e.reverse(),
                                  console.log("cdevices", e),
                                  console.log("devices", t),
                                  t.forEach(function (t) {
                                    var o = {
                                      ...
                                      r = e.find(function (t, e) {
                                        return (
                                          o.kind == t.kind && !n[t.deviceId]
                                        );
                                      });
                                    r &&
                                      ((n[r.deviceId] = !0),
                      ...
                      this.devices()
                        .then(function (t) {
                          ...
                          if (
                            ...
                            r &&
                              o.length > 1 &&
                              (r.track.label.includes("front") ||
                              r.track.label.includes("передней")
                                ? (console.log("to back"),
                                  (i = o.reverse().find(function (t) {
                                    return (
                                      t.label.includes("back") ||
                                      t.label.includes("задней")
                                    );
                                  })))
                                : r.track.label.includes("back") ||
                                    r.track.label.includes("задней")
                                  ...
                                  : (console.log("no labeled"),
                                    (i = o.find(function (t) {
                                      return t.label !== r.track.label;
                                    }))),
                              console.log("target", i),
                              i))
                          ) {
                            var a = {};
                            (a.deviceId = { exact: i.deviceId }),
                              console.log("videoConstraints", a);
                            var c = { video: a, audio: !1 };
                            navigator.mediaDevices
                              .getUserMedia(c)
                              .then(function (t) {
                  ...
                  value: function () {
                    console.log("format", this.root),
                      this.root.classList.contains("middle")
                        ? (this.root.classList.remove("middle"), this.toFull())
                        : this.root.classList.contains("full") &&
                          (this.root.classList.remove("full"), this.toMiddle());
                  }
                },
                {
                  key: "pip",
                  value: function (t) {
                    console.log("E", t),
                      this.root.classList.contains("middle")
                        ? (this.root.classList.remove("middle"), this.toMini())
                        : this.root.classList.contains("full")
                          ? (this.root.classList.remove("full"), this.toMini())
                          : (this.cancelMini(), this.toMiddle());
                  }
                },
                {
                  key: "toMiddle",
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return { x: Number(t[0]), y: Number(t[1]) };
                  }
                },
                {
                  key: "setRootTranslate",
                  value: function (t) {
                    var e = this,
                      n = t.x,
                      i = t.y;
                    window.requestAnimationFrame(function () {
                      e.root.style.transform =
                        "translate3d(" +
                        (n || 0) +
                        "px," +
                        (i || 0) +
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    var e = JSON.parse(
                      localStorage.getItem("callPositionSettings")
                    );
                    e &&
                      ((this.root.style.bottom = "auto"),
                      (this.root.style.top = e.top),
                      (this.root.style.left = e.left)),
                      (this.root.onmousedown = function (e) {
                        if (
                          ...
                          var n =
                              e.clientX - t.root.getBoundingClientRect().left,
                            i = e.clientY - t.root.getBoundingClientRect().top;
                          (t.root.style.cursor = "grabbing"),
                            (t.root.style.zIndex = 1e7),
                            (document.onmousemove = function (e) {
                              (t.root.style.bottom = "auto"),
                                e.pageY &&
                                  (window.innerHeight -
                                    t.root.getBoundingClientRect().bottom >
                                    10 && e.clientY - i > 10
                                    ? window.innerHeight -
                                        t.root.offsetHeight -
                                        11 >=
                                        e.clientY - i &&
                                      (t.root.style.top = t.getPercents(
                                        "height",
                                        e.clientY - i
                                      ))
                                    : window.innerHeight -
                                  ...
                                  e.pageX &&
                                    ...
                                    e.clientX - n < 10 &&
                                    e.movementX > 0
                                      ? (t.root.style.left = e.pageX - n + "px")
                                      : e.clientX - n > 10 &&
                                        ...
                                        ? document.body.clientWidth -
                                            ...
                                            71 >=
                                            e.pageX - n &&
                                          (t.root.style.left = t.getPercents(
                                            "width",
                                            e.pageX - n
                                          ))
                                        : document.body.clientWidth -
                            ...
                            (document.onmouseleave = function (e) {
                              e.preventDefault(),
                                ...
                                (t.root.onmouseup = null),
                                (t.root.ontouchend = null);
                            }),
                            (document.onmouseup = function (e) {
                              console.log("mouse up"),
                                localStorage.setItem(
                                  ...
                                  JSON.stringify({
                                    left: t.root.style.left,
                                    top: t.root.style.top
                                  })
                                ),
                                (document.onmousemove = null),
                                (t.root.style.cursor = "grab"),
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    switch (t) {
                      case "width":
                        n = parseInt(e, 10) / window.innerWidth;
                        break;
                      case "height":
                        n = parseInt(e, 10) / window.innerHeight;
                    }
                    return "".concat(100 * n + "%");
                  }
                },
                {
                  ...
                  value: function () {
                    this.root.classList.remove("minified"),
                      this.hammertime &&
                        (this.hammertime.off("pan"), this.hammertime.destroy()),
                      (document.onmousemove = null),
                      (this.root.style = {}),
                  ...
                  value: function (t) {
                    ...
                    void 0 === e
                      ...
                      : (console.log("init call"),
                        this.initCordovaPermisions().then(function () {
                          o.emit("initcall");
                          var e = o.matrixcs.createNewMatrixCall(o.client, t),
                            n = new Audio("js/lib");
                          return (
                            (n.autoplay = !0),
                            (n.loop = !0),
                                        ...
                                        switch ((t.prev = t.next)) {
                                          case 0:
                                            if (
                                              ...
                                              (n =
                                                this.client.store.rooms[
                                                  e.roomId
                                                ].currentState.members),
                                              (i = Object.keys(n).filter(
                                                function (t) {
                                                  return (
                                                    t !==
                                                    a.client.credentials.userId
                                                  );
                                                }
                                              )),
                                              (o = n[i]),
                ...
                },
                {
                  ...
                  value: function () {
                    var t,
                      ...
                      n =
                        null ===
                          (t = this.activeCall.feeds.find(function (t) {
                            return t.userId === e.activeCall.user.userId;
                          })) || void 0 === t
                          ? void 0
                          : t.stream;
                    try {
                      n &&
                        ...
                        (document.getElementById("local").srcObject = n);
                    } catch (t) {
                      console.log(t);
                    }
                  }
                  ...
                  value: function () {
                    ...
                    try {
                      n &&
                        ...
                        (document.getElementById("remote").srcObject = n);
                    } catch (t) {
                      console.log(t);
                    }
                  }
                    ...
                    switch (t) {
                      ...
                      case "videoCall":
                        ...
                        try {
                          ...
                          var o =
                            null ===
                              (i = localStorage.getItem("callSizeSettings")) ||
                            void 0 === i
                              ? void 0
                              : i.toString();
                          switch (
                            (this.setLocalElement(),
                            console.log("init with " + o),
                            o)
                          ) {
                            case "mini":
                              this.toMini();
                          ...
                          console.log("init interface error", t);
                        }
                    }
                  }
                },
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    console.log("addCallListeners"),
                      t.on("feeds_changed", function (t, n) {
                        console.log("feed", t),
                          e.setRemoteElement(),
                          e.setLocalElement();
                      }),
                      t.on("state", function (n, i) {
                        ...
                        console.log("state", n, t),
                          "connecting" === n &&
                            (e.signal.pause(), e.showConnecting()),
                          "connected" === n &&
                            (console.log("ready", t),
                            e.signal.pause(),
                            e.showRemoteVideo(),
                      ...
                      t.on("hangup", function (t) {
                        ...
                        if (
                          ...
                          clearInterval(e.syncInterval),
                          (e.syncInterval = null),
                          console.log("Call ended", t.callId),
                          t)
                        ) {
                          if (
                            (t.callId ===
                        ...
                        } else e.renderTemplates.clearNotify();
                      }),
                      t.on("replaced", function (t) {
                        ...
                        var n =
                          ...
                          o = n[e.client.credentials.userId];
                        (t.initiator = i),
                          (t.user = o),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return null != t &&
                      ...
                      void 0 !== n &&
                      n.image
                      ? '<img src="'.concat(t.initiator.source.image, '"/>')
                      : null !== (i = this.activeCall.initiator) &&
                          void 0 !== i &&
                          null !== (o = i.source) &&
                          void 0 !== o &&
                          o.image
                ...
                },
                {
                  ...
                  value: function () {
                    return new Promise(function (t, e) {
                      var n;
                      null !== (n = window) && void 0 !== n && n.cordova
                        ? window.BSTMedia.permissions({ audio: !0, video: !0 })
                            .then(function () {
