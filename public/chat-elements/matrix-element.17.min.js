(window["matrixElement_jsonp"] = window["matrixElement_jsonp"] || []).push([
  [17],
  {
    ...
    "29a3": function (t, o, i) {
      "use strict";
      i.r(o),
        i.d(o, "PhotoSwipe", function () {
          return h;
        }),
        i.d(o, "PhotoSwipeGallery", function () {
          return v;
        });
      var e = function () {
          var t = this,
            ...
            [
              ...
              o("div", { staticClass: "pswp__scroll-wrap" }, [
                ...
                o("div", { staticClass: "pswp__ui pswp__ui--hidden" }, [
                  o("div", { staticClass: "pswp__top-bar" }, [
                    ...
                    o("button", {
                      class:
                        "pswp__button pswp__button--download " + t.shareclass,
                      on: {
                        click: function (o) {
                          return t.downloadImage();
                        }
                      }
                    }),
                    o("button", {
        ...
        _ = {
          ...
          watch: {
            items: {
              handler: function (t, o) {
                this.pswp &&
                  this.isOpen &&
                  (this.pswp.invalidateCurrItems(), this.pswp.updateSize(!0));
              },
              deep: !0
            },
            isOpen(t, o) {
              t ? this.openPhotoSwipe(this.items, this.options) : this.close();
            }
          },
          computed: {
            shareclass: function () {
          ...
          methods: {
            openPhotoSwipe(t, o) {
              let i = this.$el;
              (this.pswp = new r.a(i, w.a, t, o)),
                n.forEach(t => {
                  this.pswp.listen(t, (...o) => {
                    o.unshift(this), this.$emit(t, [...o]);
                  });
                }),
                this.pswp.init();
            },
            downloadImage() {
              ...
              return Object(p["a"])(function* () {
                const o = t.pswp.currItem.src;
                if (window.cordova) t.$emit("sharecordova", o);
                else {
                  const t = yield fetch(o),
                    i = yield t.blob(),
                    e = URL.createObjectURL(i),
                    s = e.substring(e.lastIndexOf("/") + 1),
      ...
      function d(t) {
        var o = i("0cfc");
        o.__inject__ && o.__inject__(t);
      }
      var u = Object(b["a"])(l, e, s, !1, d, null, null, !0),
        h = u.exports,
        f = function () {
          var t = this,
            o = t._self._c;
          return o(
            "div",
            { staticClass: "{className}", attrs: { id: "{id}" } },
            [
              o(
                "div",
                  ...
                  return o(
                    ...
                    [
                      t._t(
                        ...
                        function () {
                          return [
                            o("img", { attrs: { src: i.src, alt: "picture" } })
                          ];
                        },
                        { item: i }
                      )
              ...
              o("v-photoswipe", {
                ref: "pswp",
                attrs: { isOpen: t.opened, items: t.items, options: t.options },
        ...
        g = {
          ...
          methods: {
            showPhotoSwipe(t, o) {
              t.preventDefault(),
                (this.opts = Object.assign(this.options, { index: o })),
                (this.opened = !0);
            },
            handleClose() {
              this.opened = !1;
      ...
      var x = Object(b["a"])(A, f, m, !1, k, null, null, !0),
        v = x.exports;
    },
    "3dc3": function (t, o, i) {
      var e = i("24fb"),
    ...
    4178: function (t, o, i) {
      t.exports = i.p + "img/default-skin.b257fa9c.svg";
    },
    5801: function (t, o) {
      t.exports =
    ...
    a8f4: function (t, o, i) {
      var e = i("24fb"),
        s = i("9663"),
        p = i("3dc3");
      (o = e(!1)), o.i(s), o.i(p), o.push([t.i, "", ""]), (t.exports = o);
    },
    c8cc: function (t, o, i) {
      var e = i("a8f4");
      e.__esModule && (e = e.default),
