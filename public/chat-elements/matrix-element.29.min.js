(window["matrixElement_jsonp"] = window["matrixElement_jsonp"] || []).push([
  [29],
  {
    "14fd": function (e, t, n) {
       ...
       * http://photoswipe.com
       * Copyright (c) 2019 Dmitry Semenov; */ (function (a, r) {
        (o = r),
              ...
              C && e.currItem
                ? (w.updateIndexIndicator(),
                  v.captionEl &&
                    ...
                    _(i, "caption--empty", !e.currItem.title)),
                  (b = !0))
                : (b = !1),
                I || F(),
                S();
        ...
        var e = function (e, t, n, o) {
          ...
          var u,
            ...
            ke = function (e) {
              oe &&
                (e &&
                  (x > a.currItem.fitRatio
                    ? Ie || (dn(a.currItem, !1, !0), (Ie = !0))
                    : Ie && (dn(a.currItem), (Ie = !1))),
                Oe(oe, fe.x, fe.y, x));
            },
            Ae = function (e) {
              e.container &&
            ...
            Qe = 0,
            Je = function (e) {
              je[e] && (je[e].raf && R(je[e].raf), Qe--, delete je[e]);
            },
            et = function (e) {
              je[e] && Je(e), je[e] || (Qe++, (je[e] = {}));
            },
            tt = function () {
            ...
            ot = {
              ...
              init: function () {
                if (!u && !c) {
                  ...
                  Se("firstUpdate"),
                    ...
                    void 0 === z &&
                      (Se("initialLayout"), (z = Z = i.getScrollY()));
                  var d = "pswp--open ";
                  for (
                    ...
                    Re((n + f) * xe.x, T[n].el.style);
                  P || i.bind(a.scrollWrap, v, a),
              ...
              updateCurrZoomItem: function (e) {
                ...
                (ne = a.currItem.bounds),
                  (y = x = a.currItem.initialZoomLevel),
                  (fe.x = ne.center.x),
                  (fe.y = ne.center.y),
                  e && Se("afterChange");
              },
              ...
              updateCurrItem: function (e) {
                if (0 !== ye) {
                  ...
                  if (!(e && n < 2)) {
                    ...
                    if (oe && 1 === Math.abs(ye)) {
                      var i = Qt(E);
                      i.initialZoomLevel !== x && (ln(i, he), dn(i), Ae(i));
                    }
                    (ye = 0),
                    ...
                    (o = T[c]),
                      ...
                      r && (I || r.needsUpdate || !r.bounds)
                        ? (a.cleanSlide(r),
                          ...
                          (r.needsUpdate = !1))
                        : -1 === o.index && u >= 0 && a.setContent(o, u),
                      r && r.container && (ln(r, he), dn(r), Ae(r));
                  I = !1;
                }
                (y = x = a.currItem.initialZoomLevel),
                  (ne = a.currItem.bounds),
                  ne && ((fe.x = ne.center.x), (fe.y = ne.center.y), ke(!0)),
                  Se("resize");
              },
            ...
            Dt = function () {
              return !(
                "fit" === s.scaleMode && x === a.currItem.initialZoomLevel
              );
            },
            _t = function (e, t) {
              return (
                ...
                (t(e) ? e : _t(e.parentNode, t))
              );
            },
            St = {},
            Mt = function (e, t) {
              return (
                (St.prevent = !_t(e.target, s.isClickableElement)),
            ...
            Zt = [],
            Pt = function (e) {
              while (Zt.length > 0) Zt.pop();
              return (
                O
                  ? ((ce = 0),
                    dt.forEach(function (e) {
                      0 === ce ? (Zt[0] = e) : 1 === ce && (Zt[1] = e), ce++;
                    }))
                  : e.type.indexOf("touch") > -1
                    ? e.touches &&
                      e.touches.length > 0 &&
                      ((Zt[0] = Ft(e.touches[0], Rt)),
                      e.touches.length > 1 && (Zt[1] = Ft(e.touches[1], Lt)))
                    : ((Rt.x = e.pageX),
                      (Rt.y = e.pageY),
                      (Rt.id = ""),
                      (Zt[0] = Rt)),
            ...
            zt = function (e, t) {
              ...
              if (
                ...
                (l = fe[e] + t[e] * n),
                (s.allowPanToNext || x === a.currItem.initialZoomLevel) &&
                  (oe
                    ? "h" !== ae ||
                      "x" !== e ||
                      X ||
                ...
                return (
                  void 0 !== r && (Le(r, !0), (Q = r !== pt.x)),
                  ne.min.x !== ne.max.x &&
                    (void 0 !== i ? (fe.x = i) : Q || (fe.x += t.x * n)),
                  void 0 !== r
                );
              ie || Q || (x > a.currItem.fitRatio && (fe[e] += t[e] * n));
            },
            Nt = function (e) {
              if (!("mousedown" === e.type && e.button > 0))
                if (jt) e.preventDefault();
                else if (!G || "mousedown" !== e.type) {
                  if ((Mt(e, !0) && e.preventDefault(), Se("pointerDown"), O)) {
                ...
                if (0 !== e)
                  if (
                    ...
                    if (
                      ...
                      return;
                    Pe(lt, J[1]), X || ((X = !0), Se("zoomGestureStarted"));
                    var t = It(rt, lt),
                      n = Gt(t);
                    n >
                    ...
                    if (
                      (re &&
                        ((re = !1),
                        Math.abs(st.x) >= at && (st.x -= J[0].x - ct.x),
                        Math.abs(st.y) >= at && (st.y -= J[0].y - ct.y)),
                      (ut.x = rt.x),
                      (ut.y = rt.y),
                      0 === st.x && 0 === st.y)
                    )
                      return;
                    if ("v" === ae && s.closeOnVerticalDrag && !Dt()) {
                      (pe.y += st.y), (fe.y += st.y);
                      var c = At();
                      return (
                        (Y = !0), Se("onVerticalDrag", c), Fe(c), void ke()
                      );
                    }
                    kt(Me(), rt.x, rt.y), ($ = !0), (ne = a.currItem.bounds);
                    var d = zt("x", st);
                    d || (zt("y", st), ze(fe), ke());
                  }
              }
            ...
            Ht = function (e) {
              ...
              var t;
              if ((Se("pointerUp"), Mt(e, !1) && e.preventDefault(), O)) {
                ...
                if ((tt(), W || (W = Wt()), W.calculateSwipeSpeed("x"), Y)) {
                  ...
                  if (d < s.verticalDragRange) a.close();
                    ...
                    nt(
                      ...
                      i.easing.cubic.out,
                      function (e) {
                        (fe.y = (a.currItem.initialPosition.y - p) * e + p),
                          Fe((1 - m) * e + m),
                          ke();
                      }
                    ),
              ...
              var e,
                ...
                n = {
                  ...
                  panAnimLoop: function () {
                    if (
                      je.zoomPan &&
                      ((je.zoomPan.raf = A(n.panAnimLoop)),
                      (n.now = Me()),
            ...
            Yt = function (e, t) {
              ...
              o &&
                ...
                p < 0
                  ? ((p = s.loop ? Jt() - 1 : 0), (r = !0))
                  : p >= Jt() && ((p = s.loop ? 0 : Jt() - 1), (r = !0)),
                (r && !s.loop) || ((ye += o), (ve -= o), (n = !0)));
              var c,
                d = xe.x * ve,
                m = Math.abs(d - xt.x);
              return (
                    ...
                    function () {
                      if ((Se("initialZoom" + (o ? "Out" : "In")), o)) {
                        var a = l.w / t.w,
                          ...
                          m = function (t) {
                            1 === t
                              ? ((x = a), (fe.x = l.x), (fe.y = l.y - z))
                              : ((x = (a - d) * t + d),
                                (fe.x = (l.x - s.x) * t + s.x),
                                (fe.y = (l.y - z - s.y) * t + s.y)),
                              ke(),
                              r ? (e.style.opacity = 1 - t) : Fe(p - t * p);
                          };
                        n
                          ? nt("initialZoom", 0, 1, u, i.easing.cubic.out, m, c)
                          : (m(1), (Vt = setTimeout(c, u + 20)));
                      } else
                        (x = t.initialZoomLevel),
                          Pe(fe, t.initialPosition),
                          ke(),
                          Fe(1),
                          r ? (e.style.opacity = 1) : Fe(1),
            ...
            publicMethods: {
              ...
              initController: function () {
                i.extend(s, on, !0),
                  ...
                  _e("mainScrollAnimComplete", pn),
                  _e("initialZoomInEnd", pn),
                  _e("destroy", function () {
              ...
              setContent: function (e, t) {
                ...
                if (r) {
                  ...
                  $t || t !== p ? Ae(r) : ((oe = l.style), en(r, o || r.img)),
                    (e.el.innerHTML = ""),
                    e.el.appendChild(l);
                } else e.el.innerHTML = "";
              },
            ...
            Te("DesktopZoom", {
              publicMethods: {
                ...
                handleMouseWheel: function (e) {
                  if (x <= a.currItem.fitRatio)
                    return (
                      s.modal &&
                        (!s.closeOnScroll || Qe || q
                          ? e.preventDefault()
                          : F &&
                            Math.abs(e.deltaY) > 2 &&
                            ((d = !0), a.close())),
          ...
          Te("History", {
            publicMethods: {
              ...
              onHashChange: function () {
                if (Fn() === In) return (En = !0), void a.close();
                wn || ((bn = !0), a.goTo(kn().pid), (bn = !1));
              },
              updateURL: function () {
                On(), bn || (Tn ? (gn = setTimeout(An, 800)) : An());
              }
            }
          }),
            i.extend(a, ot);
