(window["matrixElement_jsonp"] = window["matrixElement_jsonp"] || []).push([
  [0, 16, 23],
  {
    ...
    "42cd": function (t, e, a) {
      ...
      var l = Object(c["a"])(r, i, n, !1, d, "975d943a", null, !0);
      e["a"] = l.exports;
    },
    "451b": function (t, e, a) {
      var i = a("740c");
    ...
    "71da": function (t, e, a) {
      ...
      var i = function () {
          ...
          return e(
            ...
            [
              t.unauthorized
                ...
                : e("div", [
                    "Contacts" === t.mode && t.window.cordova
                            ...
                            [
                              e(
                                ...
                                [
                                  e("span", [
                                    t._v(
                                      t._s(t.$i18n.t("caption.inviteFriend"))
                                    )
                                  ]),
                                  e("i", { staticClass: "fas fa-address-card" })
                                ]
                              )
                            ],
                            1
                    ...
                    "Contacts" !== t.mode || t.window.cordova
                      ? t._e()
                      : e("div", { staticClass: "work" }, [
                          e("div", { staticClass: "inviteUserDiv" }, [
                            e(
                              "button",
                              {
                                staticClass: "inviteButton",
                                class: { colored: !0 },
                                on: { click: t.invitepnt }
                              },
                              [
                                e("span", [
                                  t._v(t._s(t.$i18n.t("caption.inviteFriend")))
                                ]),
                                e("i", { staticClass: "fas fa-address-card" })
                              ]
                            )
                    ...
                    e("div", { staticClass: "namebuttoncreate" }, [
                      "Selectmany" === t.mode && t.selectedlength
                        ? e("div", {}, [
                            e("div", { staticClass: "work" }, [
                              e("div", { staticClass: "groupList" }, [
                                e("div", { staticClass: "groupCaption" }, [
                    ...
                    e(
                      ...
                      { staticClass: "work" },
                      [
                        0 !== t.users.contacts.length
                          ? e("div", { staticClass: "titleContacts" }, [
                              e("span", [t._v(t._s(t.$t("caption.contacts")))])
                            ])
                          : t._e(),
                        e("list", {
                          attrs: {
                            mode: t.mode,
                            selected: t.selected,
                            users: t.users.contacts,
                            title: "Contacts"
                          },
                          on: { toggleUser: t.toggleUser, select: t.select }
                        })
                      ],
                      1
                    ),
                    e("div", { staticClass: "work" }, [
                      ...
                      t.inputText
                        ? t._e()
                        : e("div", { staticClass: "titleContacts empty" }, [
                            e("span", [
                              t._v(t._s(t.$t("caption.contactsempty")))
                            ])
                          ])
                    ]),
                    t.inputText.length &&
                    (t.searching ||
                      0 === t.users.contacts.length ||
                      t.users.search.length)
                      ? e("div", { staticClass: "searchResult" }, [
                          e(
                            "div",
                            { staticClass: "work" },
                            [
                              0 !== t.users.search.length
                                ? e(
                                    "div",
                                    { staticClass: "titleSearchResult" },
                                    [
                                      e("span", [
                                        t._v(t._s(t.$t("caption.searchResult")))
                                      ])
                                    ]
                                  )
                                : t._e(),
                              t.users.search.length
                                ? e("list", {
                                    attrs: {
                                      mode: t.mode,
                                      selected: t.selected,
                                      users: t.users.search,
                                      title: "Search results"
                                    },
                                    on: {
                                      toggleUser: t.toggleUser,
                                      select: t.select
                                    }
                                  })
                                : t._e()
                          ...
                          t.inputText.length >= 3 &&
                          !t.users.search.length &&
                          !t.loading &&
                          !t.searching
                            ? e("div", { staticClass: "noSearchResult" }, [
                                e("span", [
                                  t._v(t._s(t.$t("caption.queryNoResults")))
                                ]),
                                e("i", { staticClass: "fas fa-search" })
                              ])
                            : t._e(),
                          t.searching
                            ? e("div", { staticClass: "searching" }, [
                                e(
                                  "div",
        ...
        d = {
          ...
          computed: Object(o["d"])({
            ...
            users: function () {
              var t = { contacts: [], search: [] };
              return (
                (t.contacts = _.filter(this.contactsMap, t => {
                  if (
                    !this.inputText ||
                    t.name.toLowerCase().match(this.inputText.toLowerCase())
                  )
                    return !0;
                })),
                (t.search = _.filter(
                  this.fromSearch,
                  (t, e) => !this.contactsMap[t.id]
                )),
                t
              );
            },
            ...
            contactsListFiltered() {
              ...
              return (
                _.each(e, function (e, a) {
                  (e.selected = !1), t.push(e);
                }),
                t.filter(function (t) {
                  return t.name.match(a);
                })
              );
            },
            gName: function () {
          ...
          methods: {
            ...
            inviteUserAction(t) {
              var e = this.core.mtrx.client,
                a = this.chatRoomId,
                i = this;
              _.each(t, t => {
                var n = "@" + t + ":" + i.core.domain;
                e.invite(a, n).then(t => {});
              }),
      ...
      var v = Object(p["a"])(l, i, n, !1, u, "675b342a", null, !0);
      e["a"] = v.exports;
    },
    "740c": function (t, e, a) {
      var i = a("24fb");
    ...
    d3ff: function (t, e, a) {
      ...
      var i = function () {
          ...
          return e(
            ...
            [
              e("div", { staticClass: "viewWrapper" }, [
                e(
                  "div",
                  { staticClass: "uviewwr" },
                  [
                    e("userView", {
                      attrs: { userinfo: t.contact, blocked: t.blocked },
                      on: { close: t.close }
                    })
                  ],
                  1
              ...
              t.contact.id !== t.activeuser.id
                ? e(
                    "div",
                    { staticClass: "actionsWrapper" },
                    [
                      e("contactActions", {
                        attrs: { contact: t.contact, blocked: t.blocked }
                      })
                    ],
                    1
                  )
                : e("div", { staticClass: "actionsWrapper" }, [
                    e("div", { staticClass: "youw" }, [t._v("It is you")])
                  ])
            ]
          );
        },
        ...
        s = function () {
          var t = this,
            e = t._self._c;
          t._self._setupProxy;
          return e("div", { attrs: { id: "contactView" } }, [
            e(
              "div",
              { staticClass: "imageWrapper" },
              [e("userpic", { attrs: { userinfo: t.contact } })],
              1
            ),
            e("div", { staticClass: "nameWrapper" }, [
              e("span", [t._v(t._s(t.contact.name))])
            ])
          ]);
        },
        r = [],
        c = {
          ...
          created: () => {},
          watch: {},
          computed: Object(o["d"])({ auth: t => t.auth }),
          methods: {}
        },
        d = c,
        l = a("2877");
      ...
      var u = Object(l["a"])(d, s, r, !1, p, "450d7172", null, !0),
        v = u.exports,
        f = a("42cd"),
        m = function () {
          var t = this,
            e = t._self._c;
          t._self._setupProxy;
          return e("div", { attrs: { id: "contactActions" } }, [
            e("div", { staticClass: "actions" }, [
              t.tetatetid
                ? e(
                    "div",
                              ...
                              0 !== t.readyChat.length
                                ...
                                : e(
                                    ...
                                    [
                                      t._v(
                                        " " +
                                          t._s(t.$t("button.starChatButton"))
                                      ),
                                      e("i", {
                                        staticClass: "far fa-comment-alt"
                                      })
              ...
              t.blocked
                ...
                : e(
                    ...
                    [t._v(" " + t._s(t.$t("button.blockUser")) + " ")]
                  )
            ])
          ]);
        },
        ...
        g = {
          ...
          computed: Object(o["d"])({
            ...
            readyChat: function () {
              const t = this.$store.state.chats,
                e = this.tetatetid;
              return _.filter(t, t => {
                var a, i;
                return (
          ...
          methods: {
            ...
            blockUser() {
              this.core.mtrx.blockUser(this.contact.id).catch(t => {
                console.error(t);
              });
            },
            unblock() {
              this.core.mtrx.unblockUser(this.contact.id).catch(t => {
                console.error(t);
              });
            }
          }
      ...
      var w = Object(l["a"])(b, m, h, !1, x, "cb665448", null, !0),
        C = w.exports,
        k = {
          name: "contact",
          props: { contact: Object },
          components: { contactView: v, contactActions: C, userView: f["a"] },
          data: function () {
            return { loading: !1 };
          },
          created: () => {},
      ...
      var W = Object(l["a"])(y, i, n, !1, z, "69903184", null, !0);
      e["default"] = W.exports;
    },
    e97f: function (t, e, a) {
      var i = a("3351");
    ...
    f978: function (t, e, a) {
      ...
      var i = function () {
          ...
          return e(
            "div",
            { staticClass: "contactList", class: { minimized: t.minimized } },
            [
              e("RecycleScroller", {
                ...
                scopedSlots: t._u([
                  {
                    ...
                    fn: function ({ item: a }) {
                      return [
                        e("div", { staticClass: "previewWrapper minimizeex" }, [
                          "Contacts" === t.mode || "Select" === t.mode
                            ? e(
                                "div",
                                {
                                  ...
                                  on: {
                                    click: function (e) {
                                      return t.navigateToProfile(a.id, a);
                                    }
                                  }
                                },
                                [
        ...
        r = function () {
          var t = this,
            e = t._self._c;
          return e("div", { staticClass: "mod-wrapper" }, [
            e("div", { staticClass: "modal-window" }, [
              e("span", { staticClass: "message" }, [t._v(t._s(t.message))]),
              e("button", { staticClass: "btn", on: { click: t.close } }, [
                t._v("OK")
              ])
            ])
          ]);
      ...
      var v = Object(p["a"])(l, r, c, !1, u, "75ceafe2", null, !0),
        f = v.exports,
        m = {
          name: "contactsList",
          data: function () {
          ...
          components: { preview: s["a"], ModalWindow: f },
          props: {
      ...
      var b = Object(p["a"])(h, i, n, !1, g, "24811d8d", null, !0);
      e["default"] = b.exports;
    },
    faeb: function (t, e, a) {
      "use strict";
