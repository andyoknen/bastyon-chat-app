(window["matrixElement_jsonp"] = window["matrixElement_jsonp"] || []).push([
  [26],
  {
    "11f2": function (a, t, o) {
      ...
      var i = o("35d6").default;
      a.exports.__inject__ = function (a) {
        i("b1154dc8", r, a);
      };
    },
    "32fe": function (a, t, o) {
      ...
      var r = function () {
          var a = this,
            t = a._self._c;
          return t("div", { staticClass: "sa", style: a.cssVars }, [
            a.isIcon("error")
              ? t("div", { staticClass: "sa-error" }, [
                  a._m(0),
                  t("div", { staticClass: "sa-error-placeholder" }),
                  t("div", { staticClass: "sa-error-fix" })
                ])
              : a.isIcon("warning")
                ? t("div", { staticClass: "sa-warning" }, [
                    t("div", { staticClass: "sa-warning-body" }),
                    t("div", { staticClass: "sa-warning-dot" })
                  ])
                : a.isIcon("info")
                  ? t("div", { staticClass: "sa-info" }, [
                      t("div", { staticClass: "sa-info-body" }),
                      t("div", { staticClass: "sa-info-dot" })
                    ])
                  : a.isIcon("loading")
                    ? t("div", { staticClass: "sa-loading" }, [
                        t("div", { staticClass: "sa-loading-body" })
                      ])
                    : t("div", { staticClass: "sa-success" }, [
                        t("div", { staticClass: "sa-success-tip" }),
                        t("div", { staticClass: "sa-success-long" }),
                        t("div", { staticClass: "sa-success-placeholder" }),
                        t("div", { staticClass: "sa-success-fix" })
                      ])
          ]);
        },
        i = [
          function () {
            var a = this,
              t = a._self._c;
            return t("div", { staticClass: "sa-error-x" }, [
              t("div", { staticClass: "sa-error-left" }),
              t("div", { staticClass: "sa-error-right" })
            ]);
          }
        ],
        s = o("5b1b"),
        ...
        n = o("6929"),
        c = o.n(n);
      const d = ["success", "warning", "error", "info", "loading"],
        p = {
          success: "#007d09",
          warning: "#ff7800",
          error: "#ff007e",
      ...
      var l = {
          ...
          props: {
            icon: {
              type: String,
              default: "success",
              validator: a => -1 !== d.indexOf(a)
            },
            color: { type: String, validator: e.a }
          },
          computed: {
            cssVars() {
              const a = e()(this.color) ? this.color : p[this.icon];
              return {
                "--icon-color": a,
                "--icon-color-alpha": c()(a).alpha(0.25)
              };
            }
          },
          methods: {
      ...
      function f(a) {
        var t = o("ee08");
        t.__inject__ && t.__inject__(a);
      }
      var g = Object(x["a"])(b, r, i, !1, f, "5c3685b8", null, !0);
      t["default"] = g.exports;
    },
    "9a90": function (a, t, o) {
      var r = o("24fb");
