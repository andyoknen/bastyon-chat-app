(window["matrixElement_jsonp"] = window["matrixElement_jsonp"] || []).push([
  [14],
  {
    ...
    "9a41": function (t, e, a) {
      ...
      var i = function () {
          ...
          return e(
            "div",
            {
              ...
              attrs: {
                "data-viewtype": t.viewType,
                "data-is-opened-chat": t.isOpenedChat
              }
            },
            [
              e(
                        ...
                        fn: function () {
                          return [
                            e("list", {
                              ...
                              on: { scrolltop: t.scrolltop }
                            }),
                            e(
                              "transition",
                              { attrs: { name: "fademodal" } },
                              [
                                t.newChat && !t.hiddenInParent
                                  ? e("modal", {
                                      on: { close: t.closeNewChat },
                                      scopedSlots: t._u(
                                        [
                                          {
                                            key: "header",
                ...
                [
                  e(
                    ...
                    [
                      e(
                        "keep-alive",
                        [e("router-view", { key: t.activeRoomId })],
                        1
                      )
                    ],
                    1
        ...
        o =
          ...
          function () {
            ...
            return e(
              ...
              [
                t.unauthorized
                  ? e("div", { staticClass: "dmdv" })
                  : e(
                      "div",
                      [
                        !t.minimized || t.active
                          ? e(
                              "div",
                              { staticClass: "searchWrapperEA" },
                              [
                                e("simpleSearch", {
                                  attrs: { value: t.globalsearch },
                                  on: { search: t.searchall }
                                })
                              ],
                              1
                            )
                        ...
                        this.chats.length <= 2 &&
                        !0 === t.chatsready
                          ? e("teamroom", { on: { click: t.openTeamRoom } })
                          : t._e(),
                        !0 !== t.chatsready
                          ? e(
                              "div",
                          ...
                          : e("div", { staticClass: "Swipes" }, [
                              e("div", { staticClass: "desktopList" }, [
                                t.globalsearch
                                  ? e(
                                      "div",
                                      ...
                                      [
                                        e("RecycleScroller", {
                                          ...
                                          attrs: {
                                            "page-mode": "",
                                            items: t.chats,
                                            "item-size": t.pocketnet ? 60 : 70,
                                            keyField: "key",
                                            buffer: 400
                                          },
                                          on: { update: t.onScrollerResize },
                                          scopedSlots: t._u(
                                            [
                                              {
                                                key: "default",
        ...
        l = function () {
          ...
          return e(
            ...
            { staticClass: "chatswrapper" },
            [
              t._l(t.filteredLists, function ({ items: a, section: i }) {
                return a.length
                  ? e(
                      "section",
                      { staticClass: "chats" },
                      [
                        e("div", { staticClass: "section-title" }, [
                          e("span", [t._v(t._s(t.$t("caption." + i.key)))])
                        ]),
                        t._l(a, function (a) {
                          return e(
                            "div",
              ...
              t.loadedingUsers[t.search] || t.processing
                ? e(
                    "div",
                ...
                : t._e(),
              !t.filteredListsEmpty ||
              t.loadedingUsers[t.search] ||
              t.processing
                ? t._e()
                : e("div", { staticClass: "empty" }, [
                    e("span", [
                      t._v(
                        t._s(t.$t("caption.queryNoResults")) +
                          ": " +
                          t._s(t.search)
                      )
                    ])
        ...
        m = {
          name: "allContacts",
          components: { previewRoom: d["a"], previewContact: p["a"] },
          props: {
            chats: Array,
            search: String,
          ...
          computed: {
            ...Object(n["d"])(["contactsMap", "share"]),
            filteredListsEmpty: function () {
              return (
                0 ==
                _.reduce(this.filteredLists, (t, e) => t + e.items.length, 0)
              );
            },
            filteredLists: function () {
              ...
              return (
                _.each(this.lists, e => {
                  var a = this.getList(e.key);
                  a.length && (t[e.key] = { items: a, section: e });
                }),
                t
              );
            },
            filteredMessages() {
              ...
              return (
                this.search &&
                  this.processresult &&
                  _.each(this.processresult.results, (a, i) => {
                    var s = _.find(t, t => t.roomId == i);
                    s &&
                      _.each(a, t => {
                        e.push({ chat: s, messages: [t] });
                      });
                  }),
                e
              );
            ...
            filteredChats() {
              ...
              if (this.search) {
                let e = _.filter(
                  _.map(t, t => {
                    const e = this.core.mtrx.chatUsersInfo(
                        t.roomId,
                        "anotherChatUsers"
                      ),
                      a = this.core.mtrx.client.getRoom(t.roomId),
                      i = _.reduce(e, (t, e) => t + e.name.toLowerCase(), "");
                    let s = "";
                    var o;
                    a &&
                      "public" === a.getJoinRule() &&
                      a.currentState.getStateEvents("m.room.name", "").length >
                        0 &&
                      (s =
                        null ===
                          (o = a.currentState.getStateEvents(
                            "m.room.name",
                            ""
                          )[0]) || void 0 === o
                          ? void 0
                    ...
                    return (
                      r.includes(this.search) &&
                        (n = this.search.length / r.length),
                      { chat: a, point: n }
                    );
                  }),
                  t => t.point
                );
                (e = _.sortBy(e, t => t.point).reverse()),
                  (t = e.map(t => t.chat.summary));
              }
              return t;
            },
            filteredContacts() {
              return this.share
                ? []
                : ((this.contacts = _.filter(this.contactsMap, t =>
            ...
            filteredOther() {
              return (
                (this.users = _.filter(
                  this.loadedUsers[this.search] || [],
                  t =>
                    t.id !== this.core.user.userinfo.id &&
                    !_.filter(this.contactsMap, e => e.id === t.id).length
                )),
                this.users
              );
            }
          ...
          methods: {
            getList(t) {
              return (
                this["filtered" + (t.charAt(0).toUpperCase() + t.slice(1))] ||
                []
              );
            },
            loadList(t) {
            ...
            itemClick(t, e = {}) {
              if (this.mode)
                return (
                  ...
                  void this.$store.commit("setiteraction", !0)
                );
              if (
                ("navigateToProfile" == e.action &&
                  this.navigateToProfile(t.id, t),
                "navigateToRoom" == e.action)
              ) {
                var a = t;
                if (this.share) {
                  var i = this.share;
                  this.$router.push(i.route || "chat?id=" + a.roomId);
                } else this.$router.push("chat?id=" + a.roomId).catch(t => {});
              }
              if ("navigateToRoomFromMsg" == e.action) {
                a = t.chat;
                var s = t.messages[0];
                this.$router
                  .push(
              ...
              e.keepMatches || this.$emit("clearsearch");
            },
            navigateToProfile(t, e) {
              "Select" === this.mode
                ? this.select(e)
                : this.$router
                    .push({ path: "/contact?id=" + t })
                    .catch(t => {});
            },
            initSearchProcess() {
              if (!this.share)
                if (this.search.length > 2) {
                  ...
                  (this.processresult = null),
                    (this.process = this.core.mtrx.searchEngine.execute(
                      ...
                      this.chats,
                      ({ results: t }) => {
                        var e = _.reduce(t, (t, e, a) => t + e.length, 0);
                        if (e > 25) return !0;
                      },
                      {
                        all: t => {
            ...
            loadNewUsers() {
              if (!this.share)
                try {
                  var t = (this.search || "").replace(/[^a-z0-9]/g, "");
                  t.length > 3 &&
                    (this.loadedingUsers[this.search] = this.core.user
                      .searchContacts(t)
                      .then(t => {
                        this.$set(this.loadedUsers, this.search, t);
                      })
                      .catch(t => {
                        console.error(t);
                      })
          ...
          watch: {
            search: {
              immediate: !0,
              handler: function () {
                this.loadNewUsers(), this.share || this.initSearchProcess();
              }
            }
          }
        },
      ...
      var g = Object(v["a"])(u, l, h, !1, f, "29e16303", null, !0),
        b = g.exports,
        y = function () {
          var t = this,
            e = t._self._c;
          ...
          return e(
            ...
            [
              e(
                "div",
                { staticClass: "teamChatWrapper", on: { click: t.click } },
                [
                  e("div", { staticClass: "iconWrapper" }, [
                    t._m(0),
                    t.teamNotifications > 0
                      ? e("div", { staticClass: "unseen" }, [
                          t._v(" " + t._s(t.teamNotifications) + " ")
                        ])
                      : t._e()
                  ]),
                  e("div", { staticClass: "infoWrapper" }, [
                    t._m(1),
                    e("div", { staticClass: "previewMessage" }, [
                      t.pocketteammessages && t.pocketteammessages.length > 0
                        ? e("span", [
                            t._v(
                              " " +
                                t._s(
                                  t.pocketteammessages[
                                    t.pocketteammessages.length - 1
                                  ].previewText
                                ) +
                                " "
                            )
        ...
        w = [
          function () {
            ...
            return e("div", { staticClass: "logo" }, [
              e("img", {
                attrs: { src: "https://pocketnet.app/img/logo20.svg" }
              })
            ]);
          },
          function () {
            var t = this,
              e = t._self._c;
            t._self._setupProxy;
            return e("div", { staticClass: "infoName" }, [
              e("span", [t._v("Bastyon")])
            ]);
          }
        ],
        x = {
          ...
          computed: Object(n["d"])({
            ...
            teamNotifications: function () {
              var t = this;
              return _.filter(this.pocketteammessages, function (e) {
                return !t.readedteammessages[e.id];
              }).length;
            }
          }),
          methods: {
      ...
      var $ = Object(v["a"])(k, y, w, !1, C, "7df18b93", null, !0),
        j = $.exports,
        z = a("3139"),
        L = {
          name: "list",
          ...
          beforeMount: function () {
            if (this.processid) {
              var t = this.core.mtrx.searchEngine.getprocess(this.processid);
              t && t.text && (this.globalsearch = t.text);
            }
          },
          watch: {
            topchatid: function () {
              this.hmode && this.$emit("scrolltop");
            },
            minimized: {
              immediate: !0,
              handler: function () {
          ...
          computed: Object(n["d"])({
            ...
            empty: function () {
              return this.core.mtrx.ready && 0 === this.chats.length;
            },
            topchatid: function () {
            ...
            chats: function (t) {
              ...
              return (
                _.each(t.chats, t => {
                  if (t.stream) {
                    const e = this.core.mtrx.client.getRoom(t.roomId),
                      a = Date.now(),
                      i = (() => {
                        const t = this.$store._vm.core.user.myMatrixId(),
                          a = new Date(() =>
                            -9007199254740991 !== e.getLastActiveTimestamp()
                              ? e.getLastActiveTimestamp()
                              : e.getMember(t)
                                ? e.getMember(t).events.member.event
                                    .origin_server_ts
                                : void 0
                          );
                        return a.setDate(a.getDate() + 3), a.getTime();
                      })(),
                      s = a > i;
                    s &&
                      this.core.mtrx.client.leave(t.roomId).then(() => {
                        this.core.mtrx.client
                          .forget(t.roomId, !0)
                          .catch(() => {}),
                          commit("DELETE_ROOM", t.roomId);
                      });
                  }
                  if (!this.deletedrooms[t.roomId] && !t.stream) {
                    this.core.mtrx.kit.tetatetchat(this.m_chat);
                    var i = this.core.mtrx.chatUsersInfo(
                      t.roomId,
                      "anotherChatUsers"
                    );
                    (1 === i.length &&
                      i[0] &&
                      e.core.mtrx.client.isUserIgnored(
                        z["a"].getMatrixIdFull(i[0].id, e.core.domain)
                      )) ||
                      a.push(t);
                  }
                }),
            ...
            withoutBlockedChats: function () {
              var t = this;
              this.share && _.map(t.chats, function (t) {});
            },
            activeuser: function () {
          ...
          methods: {
                ...
                .then(() =>
                  Promise.all(
                    _.map(e, e => {
                      ...
                      return a.decrypted ||
                        "m.encrypted" !==
                          z["a"].deep(a, "event.content.msgtype")
                        ? Promise.resolve()
                        : t.pcrypto
                            .decryptEvent(a)
                            .then(t => ((a.decrypted = t), Promise.resolve()))
                            .catch(
                              t => (
                                (t.decrypted = { msgtype: "m.bad.encrypted" }),
                                Promise.resolve()
                              )
                            );
                    })
            ...
            remove(t) {
              this.$set(
                this.mockSwipeList,
                this.page,
                this.mockSwipeList[this.page].filter(e => e !== t)
              );
            },
            setLastEvent(t, { item: e, index: a }) {
              this.lastEventDescription = { name: t, index: a, id: e.id };
            },
            itemClick(t) {
              if (this.hmode)
                this.$store.commit("active", !0),
                  ...
                  this.$store.commit("setiteraction", !0);
              else if (this.share) {
                var e = this.share;
                this.$router.push(e.route || "chat?id=" + t.roomId);
              } else this.$router.push("chat?id=" + t.roomId).catch(t => {});
            },
            fbClick(t) {},
            sbClick(t) {},
            openTeamRoom: function () {
              this.hmode
                ...
                : (setTimeout(() => {
                  ...
                  this.$router.push("/teamroom").catch(t => {}));
            },
            onKeyDown(t) {
              16 === t.keyCode && (this.enabled = !1);
            },
            onKeyUp(t) {
              16 === t.keyCode && (this.enabled = !0);
            },
            removeRoom(t) {
              this.$dialog
                ...
                .then(e => {
                  this.core.mtrx.client.leave(t).then(e => {
                    this.core.mtrx.client
                      .forget(t, !0)
                      .then(t => t)
                      .then(e => {
                        this.$store.commit("DELETE_ROOM", t),
            ...
            tetatetchat(t) {
              if (!t) return !0;
              var e = this.core.mtrx.client.getRoom(t.roomId);
              return (
                !e ||
                this.core.mtrx.kit.tetatetchat(
                  this.core.mtrx.client.getRoom(t.roomId)
                )
              );
            },
            select: function (t) {
            ...
            toggleUser: function (t) {
              if (this.selected[t]) this.$delete(this.selected, t);
              else {
                if (this.selectedlength >= 10)
                  return void this.$store.commit("icon", {
                    icon: "warning",
                    message:
                      "At the moment, you can add no more than 10 users to the chat"
                  });
                this.$set(this.selected, t, t);
              }
              this.$emit("selectedUsers", this.selected);
            },
            shrinkResult(t, e) {
              return (t = [].concat(t)), e && t.length > e && (t.length = e), t;
            },
            itemToggle(t) {
              this[t] = this[t] ? null : 2;
            },
            searchall: function (t) {
              this.globalsearch = (t || "").toLowerCase();
            }
          },
          mounted() {
            window.addEventListener("keydown", this.onKeyDown),
              window.addEventListener("keyup", this.onKeyUp),
              this.hmode || this.$store.commit("SET_LAST_ROOM", null);
          }
        },
        T = L;
      function O(t) {
        ...
        e.__inject__ && e.__inject__(t);
        var i = a("8509");
        i.__inject__ && i.__inject__(t);
      }
      var R = Object(v["a"])(T, o, r, !1, O, "b63c01ea", null, !0),
        S = R.exports,
        I = function () {
          var t = this,
            e = t._self._c;
                        ...
                        t.share
                          ? e(
                              "div",
                              {
                                ...
                                on: { click: t.cancelShare }
                              },
                              [e("i", { staticClass: "fas fa-times" })]
                            )
                          : t._e(),
                        (t.minimized && !t.active) || !t.pocketnet || t.share
                          ? t._e()
                          : e(
                              "div",
                              {
                                staticClass: "iconbutton",
                                on: { click: t.minimizeall }
                              },
                              [e("i", { staticClass: "fas fa-times" })]
                            ),
                        t.pocketnet || t.share
                          ...
                          : e(
                              ...
                              [e("i", { staticClass: "fas fa-angle-left" })]
                            )
                      ];
                    },
                    proxy: !0
                  },
                  { key: "leftadd", fn: function () {}, proxy: !0 },
                  {
                    key: "info",
                    fn: function () {
                      return [
                        t.share
                          ? t._e()
                          : e("span", [t._v(t._s(t.$t("caption.chats")))]),
                        t.share
                          ? e("span", [t._v(t._s(t.$t("caption.shareWith")))])
                          : t._e()
                      ];
                    },
                    proxy: !0
                  },
                  {
                    ...
                    fn: function () {
                      return [
                        t.share
                          ? t._e()
                          : e("router-link", { attrs: { to: "settings" } }, [
                              e("div", { staticClass: "iconbuttonsmall" }, [
        ...
        E = {
          ...
          methods: {
            ...
            gotoapp: function () {
              this.core.backtoapp && this.core.backtoapp();
            },
            cordovashare: function () {
              var t = this.share,
                e = {};
              t.messages && (e.message = t.messages.join(". ")),
                (t.images || t.files) &&
                  ((e.files = [].concat(t.images, t.files)),
                  (e.files = _.filter(e.files, function (t) {
                    return t;
                  }))),
                window.plugins &&
                  window.plugins.socialsharing &&
                  window.plugins.socialsharing.shareWithOptions(e),
                this.cancelShare();
            },
            cancelShare: function () {
              this.share &&
                this.share.route &&
                this.$router.push(this.share.route).catch(t => {}),
            ...
            minimizeall: function () {
              this.matches.clear(), this.$store.commit("minimize", !0);
            },
            newchat: function () {
              this.$emit("newchat");
            }
      ...
      var P = Object(v["a"])(M, I, W, !1, U, "73b35124", null, !0),
        N = P.exports,
        D = a("71da"),
        A = function () {
          var t = this,
            e = t._self._c;
          t._self._setupProxy;
          return e("div", { attrs: { id: "chatcreate" } }, [
            e("div", { staticClass: "selecttype" }, [
              e("div", { staticClass: "work" }, [
                t.type
                  ...
                  : e(
                      "div",
                      { staticClass: "types" },
                      t._l(t.types, function (a) {
                        return e(
                          "div",
                          {
                            key: a.id,
                            staticClass: "type",
                            on: { click: e => t.selecttype(a.id) }
                          },
                          [
                            ...
                            e("div", [
                              e("span", [t._v(t._s(t.$t("type." + a.id)))])
                            ])
                          ]
                        );
                      }),
                ...
                t.type
                  ? e("div", { staticClass: "selectedtype" }, [
                      e(
                        "div",
                        { staticClass: "icon", on: { click: t.unselecttype } },
                        [e("i", { staticClass: "fas fa-arrow-left" })]
                      ),
                      e("div", { staticClass: "label" }, [
                        t._v(" " + t._s(t.$t("typelabel." + t.type.id)) + " ")
                      ]),
                      e("div", { staticClass: "completewrapper" }, [
                        e(
                          ...
                          [
                            t._v(" " + t._s(t.$t("caption.create")) + " "),
                            e("i", { class: t.type.icon }),
                            t.selectedLength
                              ? e("span", { staticClass: "selectedLength" }, [
                                  t._v(t._s(t.selectedLength))
                                ])
                              : t._e()
                          ]
                        )
              ...
              e("div", { staticClass: "creationbody" }, [
                t.type
                  ? e("div", { staticClass: "groupsettigns" }, [
                      e("div", { staticClass: "namebuttoncreate" }, [
                        e("div", { staticClass: "groupNameInput" }, [
                          e("label", [
                            e("input", {
                              directives: [
                                {
                              ...
                              attrs: {
                                type: "text",
                                placeholder:
                                  "privategroup" === t.type.id
                                    ? this.$i18n.t(
                                        "caption.addGroupNamePlaceHolder"
                                      )
                                    : this.$i18n.t("caption.addPublicChatName")
                              },
                              domProps: { value: t.groupName },
                              on: {
                                input: function (e) {
                                  e.target.composing ||
                                    (t.groupName = e.target.value);
                                }
                              }
                            })
                          ])
        ...
        F = {
          ...
          computed: Object(n["d"])({
            ...
            cancomplete: function () {
              return (
                !!this.type &&
                (!!(
                  "privategroup" == this.type.id &&
                  this.groupName &&
                  this.selectedLength > 0
                ) ||
                  !!(
                    "publicgroup" == this.type.id &&
                    this.groupName &&
                    this.selectedLength > 0
                  ))
              );
          ...
          methods: {
            unselecttype: function () {
              (this.type = null), (this.selected = {});
            },
            selecttype: function (t) {
              (this.type = this.types[t]), (this.selected = {});
            },
            selectedUsers: function (t) {
              this.selected = t;
            },
            selectoneuser: function (t) {
              var e = this.core.mtrx.kit.tetatetid(t, this.core.user.userinfo);
              this.$router.push("chat?id=" + e + "&u=" + t.id).catch(t => {});
            },
            complete() {
              this.createGroupAction(this.selected)
                ...
                .catch(t => {
                  ...
                  "cantcomplete" == t &&
                    (e = "Please enter a group name and add chat members"),
                    this.$store.commit("icon", { icon: "error", message: e });
                });
            },
            createGroupAction(t) {
              if (!this.cancomplete) return Promise.reject("cantcomplete");
              if (!this.type) return Promise.reject("type");
              if (_.isEmpty(t)) return Promise.reject("users");
              const e = this.core.mtrx.kit.groupIdLight(t);
              return (
                (this.$store.state.globalpreloader = !0),
                this.core.mtrx.client
                  .createRoom({
                    visibility: this.type.value,
                    invite: e.idForInviting,
                  ...
                  .then(t => ((this.$store.state.globalpreloader = !1), t))
                  .catch(
                    t => (
      ...
      var q = Object(v["a"])(G, A, B, !1, K, "48411756", null, !0),
        H = q.exports,
        J = {
          name: "pagechats",
          components: {
          ...
          methods: {
            ...
            chatcreated: function (t) {
              this.$router
                .push({ path: "chat", query: { id: t.room_id } })
                .catch(t => {});
            },
            scrolltop: function () {
      ...
      var V = Object(v["a"])(X, i, s, !1, Q, "a4126b1a", null, !0);
      e["default"] = V.exports;
    },
    "9ba4": function (t, e, a) {
      "use strict";
...
//# sourceMappingURL=matrix-element.14.min.js.map
