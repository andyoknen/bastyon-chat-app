(window["matrixElement_jsonp"] = window["matrixElement_jsonp"] || []).push([
  [3],
  {
    /***/ 7212: /***/ function (module, exports, __webpack_require__) {
      ...
      (function (g, f) {
        true
          ? f(exports, __webpack_require__("b619"), __webpack_require__("a026"))
          : undefined;
      })(this, function (exports, SwiperClass, Vue) {
        "use strict";
        SwiperClass =
          SwiperClass &&
          Object.prototype.hasOwnProperty.call(SwiperClass, "default")
            ? SwiperClass["default"]
            : SwiperClass;
        Vue =
...
***************************************************************************** */
        ...
        var handleClickSlideEvent = function (swiper, event, emit) {
          ...
          if (swiper && !swiper.destroyed) {
            var eventPath =
              ((_a = event.composedPath) === null || _a === void 0
                ? void 0
                : _a.call(event)) || event.path;
            if (
              ...
              if (
                slides_1.includes(event.target) ||
                paths.some(function (item) {
                  return slides_1.includes(item);
                })
              ) {
                var clickedIndex = swiper.clickedIndex;
                var reallyIndex = Number(
                  (_c =
                    (_b = swiper.clickedSlide) === null || _b === void 0
                      ? void 0
                      : _b.dataset) === null || _c === void 0
                    ? void 0
                    : _c.swiperSlideIndex
                );
                var reallyIndexValue = Number.isInteger(reallyIndex)
                  ? reallyIndex
                  : null;
                emit(
                ...
                emit(
                  kebabcase(ComponentEvents.ClickSlide),
                  clickedIndex,
                  reallyIndexValue
                );
              }
        ...
        function getDirective(SwiperClass, globalOptions) {
          var getStandardisedOptionByAttrs = function (vnode, key) {
            ...
            return value !== undefined
              ? value
              : (_d =
                    (_c = vnode.data) === null || _c === void 0
                      ? void 0
                      : _c.attrs) === null || _d === void 0
                ? void 0
                : _d[kebabcase(key)];
          };
          ...
          var getEventEmiter = function (vnode) {
            var _a, _b;
            var handlers =
              ((_a = vnode.data) === null || _a === void 0 ? void 0 : _a.on) ||
              ((_b = vnode.componentOptions) === null || _b === void 0
                ? void 0
                : _b.listeners);
            return function (name) {
              ...
              var _a;
              var handle =
                (_a = handlers) === null || _a === void 0 ? void 0 : _a[name];
              if (handle) {
          ...
          return {
            ...
            bind: function (element, binding, vnode) {
              // auto class name
              if (
                element.className.indexOf(DEFAULT_CLASSES.containerClass) === -1
              ) {
                element.className +=
                  (element.className ? " " : "") +
                  DEFAULT_CLASSES.containerClass;
              }
              // bind click event
            ...
            componentUpdated: function (element, binding, vnode) {
              ...
              var autoUpdate = getStandardisedOptionByAttrs(
                vnode,
              ...
              if (getBooleanValueByInput(autoUpdate)) {
                ...
                if (swiper) {
                  ...
                  if (isLoop) {
                    (_b =
                      (_a = swiper) === null || _a === void 0
                        ? void 0
                        : _a.loopDestroy) === null || _b === void 0
                      ? void 0
                      : _b.call(_a);
                  }
                  (_c =
                    swiper === null || swiper === void 0
                      ? void 0
                      : swiper.update) === null || _c === void 0
                    ? void 0
                    : _c.call(swiper);
                  (_e =
                    (_d = swiper.navigation) === null || _d === void 0
                      ? void 0
                      : _d.update) === null || _e === void 0
                    ? void 0
                    : _e.call(_d);
                  (_g =
                    (_f = swiper.pagination) === null || _f === void 0
                      ? void 0
                      : _f.render) === null || _g === void 0
                    ? void 0
                    : _g.call(_f);
                  (_j =
                    (_h = swiper.pagination) === null || _h === void 0
                      ? void 0
                      : _h.update) === null || _j === void 0
                    ? void 0
                    : _j.call(_h);
                  if (isLoop) {
                    (_l =
                      (_k = swiper) === null || _k === void 0
                        ? void 0
                        : _k.loopCreate) === null || _l === void 0
                      ? void 0
                      : _l.call(_k);
                    (_m =
                      swiper === null || swiper === void 0
                        ? void 0
                        : swiper.update) === null || _m === void 0
                      ? void 0
                      : _m.call(swiper);
                  }
                }
            ...
            unbind: function (element, binding, vnode) {
              var _a;
              var autoDestroy = getStandardisedOptionByAttrs(
                vnode,
          ...
          return Vue.extend({
            ...
            computed: {
              ...
              wrapperClass: function () {
                return (
                  this.swiperOptions.wrapperClass ||
                  DEFAULT_CLASSES.wrapperClass
                );
              }
            },
            methods: {
              ...
              autoReLoopSwiper: function () {
                ...
                if (this.swiperInstance && this.swiperOptions.loop) {
                  ...
                  (_a =
                    swiper === null || swiper === void 0
                      ? void 0
                      : swiper.loopDestroy) === null || _a === void 0
                    ? void 0
                    : _a.call(swiper);
                  (_b =
                    swiper === null || swiper === void 0
                      ? void 0
                      : swiper.loopCreate) === null || _b === void 0
                    ? void 0
                    : _b.call(swiper);
                }
              },
              updateSwiper: function () {
                ...
                if (
                  this[ComponentPropNames.AutoUpdate] &&
                  this.swiperInstance
                ) {
                  this.autoReLoopSwiper();
                  (_b =
                    (_a = this.swiperInstance) === null || _a === void 0
                      ? void 0
                      : _a.update) === null || _b === void 0
                    ? void 0
                    : _b.call(_a);
                  (_d =
                    (_c = this.swiperInstance.navigation) === null ||
                    _c === void 0
                      ? void 0
                    ...
                    : _d.call(_c);
                  (_f =
                    (_e = this.swiperInstance.pagination) === null ||
                    _e === void 0
                      ? void 0
                      : _e.render) === null || _f === void 0
                    ? void 0
                    : _f.call(_e);
                  (_h =
                    (_g = this.swiperInstance.pagination) === null ||
                    _g === void 0
                      ? void 0
                      : _g.update) === null || _h === void 0
                    ? void 0
                    : _h.call(_g);
                }
              },
              destroySwiper: function () {
                var _a, _b;
                if (
                  this[ComponentPropNames.AutoDestroy] &&
                  this.swiperInstance
                ) {
              ...
              return (
                ((_b =
                  (_a = this.$parent) === null || _a === void 0
                    ? void 0
                    : _a.swiperOptions) === null || _b === void 0
                  ? void 0
                  : _b.slideClass) || DEFAULT_CLASSES.slideClass
              );
            }
          },
          methods: {
              ...
              if (parent[ComponentPropNames.AutoUpdate]) {
                (_a =
                  parent === null || parent === void 0
                    ? void 0
                    : parent.swiperInstance) === null || _a === void 0
                  ? void 0
                  : _a.update();
              }
            }
        ...
        var getInstaller = function (SwiperClass) {
          var install = function (Vue, globalOptions) {
            ...
            if (globalOptions) {
              SwiperComponent.options.props.defaultOptions.default =
                function () {
            ...
            Vue.directive(
              CoreNames.SwiperDirective,
              getDirective(SwiperClass, globalOptions)
            );
    ...
    /***/ b619: /***/ function (
      ...
      function show() {
        for (let i = 0; i < this.length; i += 1) {
          ...
          if (
            win.getComputedStyle(el, null).getPropertyValue("display") ===
            "none"
          ) {
            // Still not visible
      ...
      */
      ...
      function updateSlides() {
        ...
        const numFullColumns = Math.floor(
      ...
      function slidePrev(
        ...
        const swiper = this;
        const { params, animating, snapGrid, slidesGrid, rtlTranslate } =
          swiper;
      ...
      function attachEvents() {
        ...
        if (
          !swiper_esm_bundle_Support.touch &&
          swiper_esm_bundle_Support.pointerEvents
        ) {
          ...
          if (swiper_esm_bundle_Support.touch) {
            const passiveListener =
              ...
              swiper_esm_bundle_Support.passiveListener &&
          ...
          if (
            (params.simulateTouch &&
              ...
              !swiper_esm_bundle_Device.android) ||
            (params.simulateTouch &&
              !swiper_esm_bundle_Support.touch &&
              swiper_esm_bundle_Device.ios)
          ) {
        ...
        if (params.updateOnWindowResize) {
          swiper.on(
            swiper_esm_bundle_Device.ios || swiper_esm_bundle_Device.android
        ...
        constructor(...args) {
          ...
          Object.keys(prototypes).forEach(prototypeGroup => {
            Object.keys(prototypes[prototypeGroup]).forEach(protoMethod => {
              if (!swiper_esm_bundle_Swiper.prototype[protoMethod]) {
                swiper_esm_bundle_Swiper.prototype[protoMethod] =
          ...
          Utils.extend(swiper, {
            ...
            touchEvents: (function touchEvents() {
              ...
              return swiper_esm_bundle_Support.touch ||
                !swiper.params.simulateTouch
                ? swiper.touchEventsTouch
                : swiper.touchEventsDesktop;
            })(),
      ...
      const Scrollbar = {
        ...
        enableDraggable() {
          ...
          const { scrollbar, touchEventsTouch, touchEventsDesktop, params } =
            swiper;
          const $el = scrollbar.$el;
          const target = $el[0];
          const activeListener =
            swiper_esm_bundle_Support.passiveListener && params.passiveListeners
      ...
      const Zoom = {
        ...
        onTouchStart(e) {
          ...
          if (swiper_esm_bundle_Device.android && e.cancelable)
            e.preventDefault();
        ...
        enable() {
          ...
          const passiveListener =
            ...
            swiper.params.passiveListeners
              ? { passive: true, capture: false }
              : false;
          const activeListenerWithCapture =
            swiper_esm_bundle_Support.passiveListener
          ...
          if (Array.isArray(controlled)) {
            for (let i = 0; i < controlled.length; i += 1) {
              if (
                ...
                controlled[i] instanceof swiper_esm_bundle_Swiper
              ) {
                setControlledTranslate(controlled[i]);
              }
            }
          } else if (
            controlled instanceof swiper_esm_bundle_Swiper &&
      ...
      const Cube = {
        setTranslate() {
          ...
          const zFactor =
            swiper_esm_bundle_Browser.isSafari ||
            swiper_esm_bundle_Browser.isWebView
              ? -swiperSize / 2
              : 0;
          $wrapperEl.transform(
      ...
      const Coverflow = {
        setTranslate() {
          ...
          if (
            swiper_esm_bundle_Support.pointerEvents ||
            swiper_esm_bundle_Support.prefixedPointerEvents
          ) {
      ...
      if (typeof swiper_esm_bundle_Swiper.use === "undefined") {
        ...
        swiper_esm_bundle_Swiper.installModule =
          swiper_esm_bundle_Swiper.Class.installModule;
      }

      swiper_esm_bundle_Swiper.use(components);

      /* harmony default export */ var swiper_esm_bundle = (__webpack_exports__[
        "default"
      ] = swiper_esm_bundle_Swiper);
      //# sourceMappingURL=swiper.esm.bundle.js.map

      /***/
    },

    /***/ d7a6: /***/ function (module, exports, __webpack_require__) {
      "use strict";
